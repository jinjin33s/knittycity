<div id="top_nav_container">
                    ...
                    <ul id="nav_main" class="sf-menu">
                        <li class="selected" style="color:yellowGreen;border-bottom: 5px solid #F8BB00" >
                            <a href="<? echo base_url() . 'kevent' ?>" style="color: #F8BB00">
                                upcoming events
                            </a>
                        </li>
                        <li>
                            <a href="<? echo base_url() . 'keventpast' ?>">
                                past events
                            </a>
                        </li>
                    </ul>
	...
	<?
		...
		else
		{
			...
			<div class="pagination">
				<? echo $this->pagination->create_links($kevent_list['pagination_info']['page'], $kevent_list['pagination_info']['page_count'], 'kevent/overview/');?>
			</div>
	<?
		}
	?>
