...
var endTimelist = "<select name='calendarEndTime' id='calendarEndTime'>"
 ...
 $(document).ready(function() {
     ...
     $('#calendarEndTime').replaceWith(timelist);
...
<div class="box">
	...
	?>
	<? echo form_open('admin/kcalendar/add'); ?>
			...
			<tbody>
					...
					<td>
						<?
							$data = array(
							              ...
							              'maxlength'   => '100',
							              'size'        => '85',
							              'value'		=> set_value('calendarLocation')
							            );
					...
					<td>
						<?
							$data = array(
							              ...
							              'size'        => '85',
                                                                      'style'       =>'height:50px;',
							              'value'		=> set_value('calendarSummary')
							            );
					...
					<td>End Date</td>
							...
							$data = array(
							              ...
							              'maxlength'   => '2c',
							              'size'        => '20',
							              'value'		=> set_value('calendarEndDate')
							            );
