			...
			<tbody>
				...
				<tr>
					<td>
						<?
							$data = array(
							              'name'        => 'config_other_entries_per_page',
							              'id'          => 'config_other_entries_per_page',
							              'maxlength'   => '2',
							              'size'        => '5',
							              'value'		=> set_value('config_other_entries_per_page', $config['config_other_entries_per_page'])
							            );
