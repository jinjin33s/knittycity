...
var endTimelist = "<select name='classEndTime' id='classEndTime'>"
 ...
 $(document).ready(function() {
     ...
     $('#classTime').val('<?= $kclass['classTime'];?>');

     $('#classEndTime').replaceWith(endTimelist);
     $('#classEndTime').val('<?= $kclass['classEndTime'];?>');

     $('#classDate').datepicker({dateFormat:'yy-mm-dd'});
     $('#classDate').val('<?= $kclass['classDate'];?>');
 });
...
<div class="box">
	...
	?>
	<? echo form_open('admin/kclass/edit/'.$kclass['class_id']); ?>
			...
			<tbody>
					...
					<td>
						<?
							$data = array(
							              ...
							              'maxlength'   => '100',
							              'size'        => '85',
							              'value'		=> set_value('classTitle', $kclass['classTitle'])
							            );
					...
					<td>
						<?
							$data = array(
							              ...
							              'maxlength'   => '100',
							              'size'        => '85',
							              'value'		=> set_value('classInstructor', $kclass['classInstructor'])
							            );
					...
					<td>Start Date</td>
							...
							$data = array(
							              ...
							              'maxlength'   => '20',
							              'size'        => '20',
							              'value'		=> set_value('classDate', $kclass['classDate'])
							            );
				...
				<tr>
                                        <td>Start Time</td><td> <?
                                                $data = array(
                                                              ...
                                                              'maxlength'   => '20',
                                                              'size'        => '20',
                                                              'value'		=> set_value('classTime', $kclass['classTime'])
                                                            );
                                ...
                                <tr>
                                        <td>End Time</td><td> <?
                                                $data = array(
                                                              ...
                                                              'maxlength'   => '20',
                                                              'size'        => '20',
                                                              'value'		=> set_value('classEndTime', $kclass['classEndTime'])
                                                            );
					...
					<td>
						<?
							$data = array(
							              ...
							              'value'       => set_value('classSummary', $kclass['classSummary'])
							            );
