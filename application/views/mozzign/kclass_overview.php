<div id="top_nav_container">
                    ...
                    <ul id="nav_main" class="sf-menu">
                        <li class="selected" style="color:yellowGreen;border-bottom: 5px solid yellowGreen" >
                            <a href="<? echo base_url() . 'kclass' ?>" style="color:yellowGreen;">
                                upcoming classes
                            </a>
                        </li>
                        <li>
                            <a href="<? echo base_url() . 'kclasspast' ?>">
                                past classes
                            </a>
                        </li>
                    </ul>
...
<div class="postlist">
      ...
      <!--
      <td><b><a href="<? echo base_url() . 'kclass' ?>"> upcoming classes</a></b></td> &nbsp;&nbsp;&nbsp;&nbsp;
      <td><b><a href="<? echo base_url() . 'kclasspast' ?>"> past classes</a></b></td>
      -->
	...
	<? }else{
        if(count($error_list) > 0 OR count($notice_list) > 0){ ?>
			...
			<div class="pagination">
				<? echo $this->pagination->create_links($kclass_list['pagination_info']['page'], $kclass_list['pagination_info']['page_count'], 'kclass/overview/');?>
			</div>
	<?
		}
	?>
