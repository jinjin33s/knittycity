...
<link rel="stylesheet" type="text/css" href="<?php shared_url("js/jquery/ui/themes/ui-lightness/ui.all.css");?>" />
<script type="text/javascript" src="<?php shared_url("javascript/jquery/jquery-1.3.2.min.js");?>" ></script>
<script type="text/javascript" src="<?php shared_url("javascript/jquery/ui/ui.core.js");?>"></script>
<script type="text/javascript" src="<?php shared_url("javascript/jquery/jstree/jquery.tree.min.js");?>"></script>
<script type="text/javascript" src="<?php shared_url("javascript/jquery/ajaxupload.js");?>"></script>
<script type="text/javascript" src="<?php shared_url("javascript/jquery/ui/ui.draggable.js");?>"></script>
<script type="text/javascript" src="<?php shared_url("javascript/jquery/ui/ui.resizable.js");?>"></script>
<script type="text/javascript" src="<?php shared_url("javascript/jquery/ui/ui.dialog.js");?>"></script>
<script type="text/javascript" src="<?php shared_url("javascript/jquery/ui/external/bgiframe/jquery.bgiframe.js");?>"></script>
<style type="text/css">
body {
	padding: 0;
	margin: 0;
