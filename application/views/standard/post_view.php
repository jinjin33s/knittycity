						<div class="post_view">
							...
							?>
											...
											<? echo anchor('post/view/'.$post['post_id']."/".$comment['comment_id']."/#comment-".$comment['comment_id'], $comment['comment_date_create_formatted']); ?>
							...
							?>
									...
									<?
										...
										{
									?>
											<table cellpadding="0" cellspacing="0" class="comment_form_error">
												<tbody>
													<?
									...
									<? echo form_open('post/view/'.$post['post_id'].'#reply'); ?>
										<table cellpadding="0" cellspacing="0" class="comment_form">
											<tbody>
												<?
