...
class Kclasspast extends MY_Controler {
	...
	function overview($page = 1)
	{
		...
		$this->view->add_data('kclass_list', $this->Kclass_model->get_kclass_list_by_past($page));

                //$this->view->show('Kclass', 'kclass_overview');
                $this->view->show_knitty('Kclasspast', 'kclass_overview_past','class_template');
	}
