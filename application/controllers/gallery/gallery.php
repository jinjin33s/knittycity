...
class Gallery extends Controller {
	...
	function index() {
		...
		$this->view->showGallery('gallery_view', $data);
	}
	function view() {
		$data['rows'] = $this->gallery_tbl->viewParticular($this->uri->segment(3));
		$this->view->showGallery('category_view_id', $data);
	}
	function add() {
		$this->view->showGallery('category_insert');
	}
	function insert() {
	...
	function update() {
		$data['rows'] = $this->gallery_tbl->viewParticular($this->uri->segment(3));
		$this->view->showGallery('category_update', $data);
	}
	function updatecat() {
	...
	function delete() {
		$data['rows'] = $this->gallery_tbl->viewParticular($this->uri->segment(3));
		$this->view->showGallery('category_delete', $data);
	}
	function deleterow() {
	...
	function images() {
		...
		$this->view->showGallery('image_view', $data);
	}
	function addimage() {
		$data['info'] = $this->gallery_tbl->viewParticular($this->uri->segment(3));
		$this->view->showGallery('image_insert', $data);
	}
	function updateimage() {
		$data['rows'] = $this->gallery_tbl->particularImage($this->uri->segment(3));
		$this->view->showGallery('image_update', $data);
	}
	...
	function removeimage() {
		...
		$this->view->showGallery('image_delete', $data);
	}
	function do_remove() {
